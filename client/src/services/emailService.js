  ...
  submitContactForm: async (formData) => {
    try {
      const response = await contactService.submitContact({
        ...formData,
        formType: formData.formType || 'General Contact'
      });
      return response;
    } catch (error) {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; padding: 20px; background: #14b8a6; color: white; border-radius: 8px;">
          ...
          <p style="margin: 5px 0;"><strong>Phone:</strong> <strong>+971-528477349</strong></p>
          <p style="margin: 5px 0;"><strong>Email:</strong> <strong>Yashaswi.das@ydadvisory.ae</strong></p>
          <p style="margin: 5px 0;"><strong>Website:</strong> <strong>www.ydadvisory.ae</strong></p>
        </div>
