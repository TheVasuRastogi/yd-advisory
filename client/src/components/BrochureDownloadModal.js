...
const BrochureDownloadModal = ({ isOpen, onClose, brochureUrl }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("formType", "Brochure Download Request");
      formData.append("subject", `Brochure Download Request from ${data.email}`);
      formData.append("message", `User requested brochure download with email: ${data.email} and phone: ${data.phone || 'Not provided'}`);
